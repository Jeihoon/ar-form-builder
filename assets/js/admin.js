jQuery(document).ready(function ($) {
    ...
    // Open the field editor modal and log that the function is called.
    function openFieldEditor($field) {
        ...
        if (fieldType === "checkbox_group" || fieldType === "radio_group" || fieldType === "drop_down_list") {
            ...
            var currentOptions = $field.attr("data-options") ? JSON.parse($field.attr("data-options")) : [];
    ...
    function loadSavedForm(formID) {
        ...
        if (AminFormBuilder.saved_forms && AminFormBuilder.saved_forms[formID]) {
            ...
            savedFields.forEach(function (field) {
                ...
                var newField = $("<div class='dropped-field' data-field='" + field.field + "' data-column='" + columnNumber + "' data-row='" + rowNumber + "' data-options='" + (field.options ? JSON.stringify(field.options) : "") + "' data-title='" + (field.title ? field.title : "") + "'" +
    ...
    function makeColumnsDroppable() {
        $(".droppable-column").droppable({
            ...
            drop: function (event, ui) {
                ...
                var newField = $("<div class='dropped-field' data-field='" + fieldType + "' data-column='" + columnNumber + "' data-row='" + rowNumber + "' data-title='" + fieldLabel + "' data-required='false'>" +
    ...
    function saveFieldOptions() {
        ...
        if ($editField) {
            ...
            var newField = $("<div class='dropped-field' data-field='" + fieldType + "' data-column='" + columnNumber + "' data-row='" + rowNumber + "' data-title='" + fieldTitle + "'" +
